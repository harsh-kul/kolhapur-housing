...
<head>
  ...
  <link rel="stylesheet" href="css/internal/index/rent_pp_index.css">
  <script src="js/rent_index.js"></script>
...
<body>
  ...
  <section class="displayScreen">
    ...
    <main>
      ...
      <section>
        <div class="container">
          ...
          <div id="cards-container">
            <div class="cards" id="rentcarouselItem">
      ...
      <section>
        <div class="container">
          <div class="row" id="rentfourStaticCards">
