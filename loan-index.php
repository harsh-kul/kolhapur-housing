...
echo 'AlertHandler.getErrorAlert(StringHandler.REQ_LOAN_VALID_EMI);';
echo '</script>';
...
if (isset($_SESSION['id'])) {
  ...
  // echo("not session");
  echo '<script type="text/javascript">';
  echo 'alert(AlertHandler.getErrorAlert(StringHandler.REQ_LOAN_VALID_EMI) );';
  echo '</script>';
  $url = __URL_loginpage_;
  header('Location: ' . $url);
          ...
          <div class="row">
            <div class="col-md search-wrap">
              <form action="#" class="search-property">
                <div class="row">
                  <input type="hidden" class="inputText form-control form-control-lg" id="fk_regid" value=<?php echo $_SESSION['id'] ?>>
                  ...
                  <script>
                    ...
                    if (isNaN(lonerequestid)) {
                      ...
                      $("#btnfroloans").append(
                        "<div class='col-md align-items-end'>" +
                        "<div class='form-group'>" +
                        "<button id='btn_update_lonerequest' class='form-control btn btn-primary' value='Update'>Update</button> " +
                        "</div>" +
                        "</div>"
                      );
                    }
