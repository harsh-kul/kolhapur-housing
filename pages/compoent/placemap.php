...
<section class="ftco-section-parallax pt-5" id="contactus">
					...
					<div class="row d-flex justify-content-center mt-5">
						<div class="col-md-8">
							<form action="#" class="subscribe-form">
								...
								<div class="form-group d-flex">
									<input type="button" value="Subscribe" class="submit px-3" id="subscribe-btn">
								</div>
							</form>
						</div>
					</div>
					...
					<div class="mb-4">
						<div class="mapouter">
							<div class="gmap_canvas"><iframe width="100%" height="100%" id="gmap_canvas"
									src="https://maps.google.com/maps?q=D Marrt Rankala&t=&z=14&ie=UTF8&iwloc=&output=embed"
